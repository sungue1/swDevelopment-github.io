...
public class TrainCrawling {
    ...
    final String url;
    com.example.SW_PBL.Train.Date Date = new Date();
    public String date = Date.td;
    public String[][] DataTable = new String[1000][6];
    public int size = 0;
            ...
            while (true) {
                ...
                for (WebElement tr : trList) {
                    ...
                    if (dist.indexOf("KTX") == 0) {
                        String dep = tdList.get(2).getText();
                        dep = dep.substring(0, dep_len);
                        String arr = tdList.get(3).getText();
                        arr = arr.substring(0, arr_len);
                        ...
                        String tmp = prc.substring(5,6);
                        if (tmp.equals("원")) {
                            prc = prc.substring(0, 5);
                        }
                        else {
                        ...
                        DataTable[size][0] = dep;
                        DataTable[size][1] = arr;
                        DataTable[size][2] = etd;
                        DataTable[size][3] = eta;
                        DataTable[size][4] = prc;
                        DataTable[size][5] = dur;
                        size++;
                    }
                    i++;
                }
